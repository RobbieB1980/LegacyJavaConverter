...
262-repair remaps (compile + in-game leftovers) are indexed for retrieval outside this converter at `C:\GokuCodexAI\Data\262r` (MCP category `262r`, version `26.2`).

Station MCreator upstream (not shipped here): `C:\GokuCodexAI\Data\_upstream\mcreator`
