...
- Indexer policy: **GokuAI only** (`C:\GokuCodexAI\Data`). Do not register external `H:\` trees.

## Registered source roots

Policy: **GokuAI only** — index `C:\GokuCodexAI\Data` (`local`). External trees (e.g. `H:\GrokBuild_MF\Completed_Projects`) are not registered.

- `local` -> `C:\GokuCodexAI\Data` (27785 indexed files; available)

## Exact-version entrypoints

- Compact primer_changes ledger: `C:\GokuCodexAI\Data\NeoForge_Primers\26.2\primer_changes_1.20.1-to-26.2.md`
- Target primer (full, only if needed): `C:\GokuCodexAI\Data\_upstream\neoforge_primers\primers\26.2\index.md`
- Source Minecraft reference: `C:\GokuCodexAI\Data\Minecraft_Java_Server_Client\1.20.1\_SOURCE.json`
- Source MCPConfig: `C:\GokuCodexAI\Data\_upstream\mcpconfig\versions\release\1.20.1\config.json`
- Target Gradle reference: `C:\GokuCodexAI\Data\Exact_Version_Sources\NeoForge\26.2\gradlew`
- Primer_changes shards: `C:\GokuCodexAI\Data\NeoForge_Primers\26.2\primer_changes_1.20.1-to-26.2`
- 262-repair knowledge (category `262r`): `C:\GokuCodexAI\Data\262r`

- Mapping corpus: `C:\GokuCodexAI\Data\Minecraft_Mappings_Corpus\mappings.v3.1787973081.db` (ready)
