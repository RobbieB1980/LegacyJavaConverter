...
public sealed class SetupForm : Form
{
    ...
    public SetupForm()
    {
        ...
        var title = new Label
        {
            Text = AppDisplayName + " v" + (Assembly.GetExecutingAssembly().GetName().Version?.ToString(3) ?? "2.10.5"),
    ...
    {
        var version = Assembly.GetExecutingAssembly().GetName().Version?.ToString(3) ?? "2.10.5";
