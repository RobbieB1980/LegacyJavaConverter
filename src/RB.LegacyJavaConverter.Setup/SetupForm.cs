...
public sealed class SetupForm : Form
{
    ...
    public SetupForm()
    {
        ...
        var title = new Label
        {
            Text = AppDisplayName + " v" + (Assembly.GetExecutingAssembly().GetName().Version?.ToString(3) ?? "2.0.4"),
    ...
    {
        var version = Assembly.GetExecutingAssembly().GetName().Version?.ToString(3) ?? "2.0.4";
